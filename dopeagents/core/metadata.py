...
class AgentMetadata(BaseModel):
    ...
    tags: list[str] = Field(
        default_factory=list, description="Searchable tags for discovery"
    )
    requires_llm: bool = Field(
        default=True, description="Whether this agent requires LLM calls"
    )
    ...
    system_prompt: str = Field(
        default="", description="System prompt used by this agent"
    )
